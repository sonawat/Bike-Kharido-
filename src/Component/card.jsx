...
const obj3 = () =>
    ...
    return (
        ...
        <span><button className='jspan1' style={{ border: 'none', backgroundColor: 'white' }} onClick={obj1}> POPULAR BIKES</button></span>
        <span><button className='jspan2' style={{ border: 'none', backgroundColor: 'white' }} onClick={obj2}> LATEST BIKES</button></span>
        <span><button className='jspan3' style={{ border: 'none', backgroundColor: 'white' }} onClick={obj3}> ELECTRIC BIKES</button></span>
